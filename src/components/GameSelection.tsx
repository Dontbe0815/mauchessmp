  ...
  const games = [
    {
      ...
      players: '1-2 Spieler',
      features: ['Sonderkarten', 'Mau-Regeln', 'KI-Gegner'],
    ...
    },
    {
      ...
      players: '1-2 Spieler',
      features: ['Alle Regeln', 'En Passant', 'Rochade', 'KI-Gegner'],
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <div className="pt-24 pb-12 px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Spiele klassische Brett- und Kartenspiele. 
            Gegen die KI oder zu zweit am selben Gerät.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Alle Spiele können gegen eine KI gespielt werden. 
                Wähle zwischen verschiedenen Schwierigkeitsstufen!
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-sm border-t px-4 py-3 text-center">
        <p className="text-sm text-gray-500">
          Spieleck • Kartenspiele & Schach • Made with ❤️
        </p>
      </div>
    </div>
  );
